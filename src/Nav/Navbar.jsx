...
function Navbar() {
  return (
    <nav className="flex w-[80vw] items-center justify-between bg-slate-50 p-2 m-auto">
      <img src={logo} width={76} height={50} alt="" />
      <ul className="flex items-center justify-between space-x-2 font-mono max-md:hidden">
        {menu.map((link, index) => (
          <li
